...
public class FloatingViewService extends Service implements View.OnClickListener {
    ...
    public void onCreate() {
        ...
        mFloatingView = LayoutInflater.from(this).inflate(R.layout.activity_floater, null);
    ...
    public static void stopFloatingService(Context ctx){
        if(isRunningFlag) {
            if (mFloatingView != null) mWindowManager.removeView(mFloatingView);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.collapsed_iv:
                Intent i = new Intent();
                i.setClass(this, com.retailx.dreamdx.retailx.MainActivity.class);
